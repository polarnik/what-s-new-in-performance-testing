...
# Развитие __коммуникативных__ навыков, __языковых__ навыков и тестирования __в облаках__ очень важны

---

<!-- _class: main2 -->

# 📝 Тестирование __обновления__, __масштабирования__ и __автомасштабирования__
...
## ⚙️ ElasticSearch, OpenSearch, Grafana
...
![bg h:80%](img/simple.tests.and.jaeger.png)
...
![bg h:80%](img/simple.tests.and.complex.png)
...
# Автоматизация нагрузки по расписанию или кнопке через __Jenkins__, __Github Actions__
